...
IMG_PATH = "../All/test_img"
fw = os.listdir(IMG_PATH)
# path of save xml file
save_path = '' # keep it blank

# txt_folder is txt file root that using darknet rectbox
txt_folder = '../All/test_txt'

# (NOTICE #3)
# Change this labels
labels = ['di_bo', 'xe_dap', 'xe_may', 'xe_hang_rong', 'xe_ba_gac', 'xe_taxi', 
          'xe_hoi', 'xe_ban_tai', 'xe_cuu_thuong', 'xe_khach', 'xe_buyt',
          'xe_tai', 'xe_container', 'xe_cuu_hoa']
global label
label = ''
